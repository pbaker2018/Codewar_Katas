...
#
# Another example, take 1634 (4 digits):
#
...
def narcissistic?( value )
  narcissistic = value.digits.reverse.reduce(0){
    |sum, num| sum += num ** value.digits.length
  }
  return true if narcissistic == value
  return false if narcissistic != value
end
