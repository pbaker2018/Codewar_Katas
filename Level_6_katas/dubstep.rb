...
# dubstep music in his performance.
...
# of words "WUB" before the first word of the song (the number may be zero), after
...
# into modern music, he decided to find out what was the initial song that Polycarpus remixed.
